                ...
                Array(3).fill('2').map((media, index) => (
                  <SwiperSlide className='w-full' key={index}>
                    ...
                    <div className="py-6 dark:bg-transparent bg-white dark:px-0 px-2">
                      ...
                      <div className='lg:text-xl text-lg leading-[1.6] font-semibold font-dmsans my-2 dark:text-white text-black/80'>Virat Kohli to flag off inaugural one8 Run in Bengaluru</div>
